class Conta:
    ...
    def __init__(self, nome="", conta="", agencia = '', saldo=0):
        self.nome = nome
        self.conta = conta
    ...
    def consulta(self):
        ...
        print('Número da agencia: ' + self.agencia)
...
class Banco:
    ...
    def iniciaConta(self):
        ...
        novaConta = Conta(nome, conta, agencia)
        self.listaDeContas.append(novaConta)
        self.menuBanco()
        
    def acessarConta(self):
        conta = input('Por favor, entre com o número da conta:\n')
